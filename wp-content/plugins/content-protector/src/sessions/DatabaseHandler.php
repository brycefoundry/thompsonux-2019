...
class DatabaseHandler extends SessionHandler {
    ...
    public function __construct() {
        ...
        add_action( 'admin_init', array( __CLASS__, 'create_table' ) );
        add_action( 'wp_session_init', array( __CLASS__, 'create_table' ) );
        add_action( 'wp_install', array( __CLASS__, 'create_table' ) );
    }
    /**
